...
// Much like the registry on windows allows COM to expose version"ed" (IMyInterface1, IMyInterface2), set in stone,
// interfaces as backwards compatible windows into the core systems, this system allows us to do the same across
// versions of Unity.
//
// Developers should strive to maintain absolute backwards compatibility in old versions of an interface while
// new versions of the interface are the means by which we grow the system.
//
// USAGE:
// ---------
// To retrieve an interface a user can do the following from a plugin, it the interface is registered on the
// plugin, and assuming they have the header file for the interface:
//
// IMyInterface * ptr = registryInterface->Get<IMyInterface>();
//
//
// Internally we register a version of the interface like so
// assuming MyInterfaceSingleton implements IMyInterface:
//
// registryInterface->Register((IMyInterface*)&MyInterfaceSingleton);
//
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//
// Template specialization is used to produce a means of looking up a GUID from it interface type at compile time.
